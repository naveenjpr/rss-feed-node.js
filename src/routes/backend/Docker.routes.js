...
module.exports = (app) => {
  route.post("/add", upload.array("images", 5), DockerController.create); //http://localhost:5000/api/backend/Docker/add
  ...
  route.put("/update/:id", upload.array("images", 5), DockerController.update); // http://localhost:5000/api/backend/Docker/update
