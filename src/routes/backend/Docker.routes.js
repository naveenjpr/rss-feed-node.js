...
module.exports = (app) => {
  route.post("/add", upload.array("images", 10), DockerController.create); //http://localhost:5000/api/backend/Docker/add
  ...
  route.put("/update/:id", upload.array("images", 10), DockerController.update); // http://localhost:5000/api/backend/Docker/update
  ...
  route.delete(
    "/delete-image",
    upload.none(),
    DockerController.deleteSingleImage,
  );
