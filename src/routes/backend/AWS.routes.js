...
module.exports = (app) => {
  route.post("/add", upload.array("images", 10), AWSController.create); //http://localhost:5000/api/backend/AWS/add
  ...
  route.put("/update/:id", upload.array("images", 10), AWSController.update); // http://localhost:5000/api/backend/AWS/update
